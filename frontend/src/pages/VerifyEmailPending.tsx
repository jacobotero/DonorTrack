  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
        ...
        <p className="font-medium text-gray-800 dark:text-gray-200 mb-6">{user.email}</p>
        ...
        {resendMessage && (
          <div className={`text-sm rounded-lg p-3 mb-4 ${resendMessage.includes("Failed") ? "bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400" : "bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400"}`}>
            {resendMessage}
          </div>
        )}
